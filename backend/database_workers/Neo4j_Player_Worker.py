...
class Player_Worker:
    ...
    def add_personal_data_to_player(self, name, country, rank, rank_level, status, experience, play_style, previous_win_year, age, height, favorite_shot, hand, personality_tags, personality_long, grass_advantage, career_high_rank, years_on_tour, coach, image_url, gender, country_code, career_high_year):
        with self.driver.session(database="neo4j") as session:
            result = session.execute_write(
                self._add_personal_data_to_player, name, country, rank, rank_level, status, experience, play_style, previous_win_year, age, height, favorite_shot, hand, personality_tags, personality_long, grass_advantage, career_high_rank, years_on_tour, coach, image_url, gender, country_code, career_high_year)

            return result
        
    @staticmethod
    def _add_personal_data_to_player(tx, name, country, rank, rank_level, status, experience, play_style, previous_win_year, age, height, favorite_shot, hand, personality_tags, personality_long, grass_advantage, career_high_rank, years_on_tour, coach, image_url, gender, country_code, career_high_year):
